...
TEST(earth, CalculatePlanetaryNutationArguments) {
  ...
  // 0.49556537320517435
  EXPECT_NEAR(args.L_Me, 0.49556537320517435, 1e-14);

  // Venus, eraFave03().
  // >>> import erfa
  // >>> erfa.fave03(0.21767284875402437)
  // 5.580156943919512
  EXPECT_NEAR(args.L_Ve, 5.580156943919512, 1e-14);

  // Earth, eraFae03().
  // >>> import erfa
  // >>> erfa.fae03(0.21767284875402437)
  // 0.2888954765644911
  EXPECT_NEAR(args.L_E, 0.2888954765644911, 1e-14);

  // Mars, eraFama03().
  // >>> import erfa
  // >>> erfa.fama03(0.21767284875402437)
  // 3.521319577133312
  EXPECT_NEAR(args.L_Ma, 3.521319577133312, 1e-14);

  // Jupiter, eraFaju03().
  // >>> import erfa
  // >>> erfa.faju03(0.21767284875402437)
  // 5.846295269553211
  EXPECT_NEAR(args.L_J, 5.846295269553211, 1e-14);

  // Saturn, eraFasa03().
  // >>> import erfa
  // >>> erfa.fasa03(0.21767284875402437)
  // 5.516959138332685
  EXPECT_NEAR(args.L_Sa, 5.516959138332685, 1e-14);

  // Uranus, eraFaur03().
  // >>> import erfa
  // >>> erfa.faur03(0.21767284875402437)
  // 0.8259009242662891
  EXPECT_NEAR(args.L_U, 0.8259009242662891, 1e-14);

  // Neptune, eraFane03().
  // >>> import erfa
  // >>> erfa.fane03(0.21767284875402437)
  // 6.14193893689622
  EXPECT_NEAR(args.L_Ne, 6.14193893689622, 1e-14);

  // General accumulated precession in longitude., eraFapa03().
  // >>> import erfa
  // >>> erfa.fapa03(0.21767284875402437)
  // 0.005307500219818061
  EXPECT_NEAR(args.p_A, 0.005307500219818061, 1e-14);
}
