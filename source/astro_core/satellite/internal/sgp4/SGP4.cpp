...
namespace SGP4Funcs
{
	...
	*    vallado, crawford, hujsak, kelso  2006
		...
		)
	{
		...
		// only do it if the source and destination is different. this solves ASAN
		// warning when twoline2rv() is used (it passes satrec.satnum as satn).
		if (satrec.satnum != satn) {
		#ifdef _MSC_VER
